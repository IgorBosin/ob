...
const DynamicTable = <DataRowType extends Record<string, string | number>>({
                                                                             columns,
                                                                             data,
                                                                             setData,
                                                                           }: Props<DataRowType>) => {
  const [sortConfig, setSortConfig] = useState<{ key: keyof DataRowType | null; direction: 'asc' | 'desc' }>({
    key: null,
    direction: 'asc',
  });

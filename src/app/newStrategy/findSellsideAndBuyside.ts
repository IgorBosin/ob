...
import {findBuyside} from "app/newStrategy/findLiquidity/findBuyside";
import {findSellside} from "app/newStrategy/findLiquidity/findSellside";

export const findSellsideAndBuyside = async (symbols: string,

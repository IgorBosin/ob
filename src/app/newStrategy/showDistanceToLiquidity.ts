import {findSellsideAndBuyside} from "app/newStrategy/findSellsideAndBuyside";
import {symbolPrice} from "shared/api/symbolPrice";
import {showPercentToLowerPrice, showPercentToTopPrice} from "utils/showPercentBetweenTwoPrices";

export const showDistanceToLiquidity = async (symbols: string,
